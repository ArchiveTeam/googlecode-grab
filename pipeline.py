...
project = Project(
    ...
    project_html="""
        ...
        <h2>code.google.com <span class="links"><a href="https://code.google.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/googlecode/">Leaderboard</a></span></h2>
